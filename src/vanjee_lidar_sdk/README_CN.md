...
- vanjee_722
- vanjee_722d
- vanjee_722f (WLR-722F, WLR-722G网口版本)
- vanjee_722h (WLR-722H, WLR-722T, WLR-722X)
- vanjee_722z (WLR-722G串口版本, WLR-722S, WLR-722Z)
- vanjee_732
- vanjee_733
- vanjee_750
- vanjee_760
...
**如果需要使用WLR-760,编译时需要开启宏定义 "FILTER_DLL_ENABLE=ON"**
**如果编译或运行报错提示，无法找到 "libVanJeeLaser760Filter_linux_x86.so" 或 "libVanJeeLaser760Filter_linux_aarch64.so" 需要做如下操作**
```sh
...
sudo ldconfig
```
**如果编译或运行依旧报错提示，无法找到 "libVanJeeLaser760Filter_linux_x86.so" 或 "libVanJeeLaser760Filter_linux_aarch64.so" 还需要做如下操作**
需要查看动态库权限，可执行如下指令
```sh
