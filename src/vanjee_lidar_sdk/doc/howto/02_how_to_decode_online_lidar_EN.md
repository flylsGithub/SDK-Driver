...
Before reading this document, please ensure that you have already read the LiDAR user manual and the [Parameter Introduction](../intro/02_parameter_intro_EN.md) .
...
Set ```angle_path_hor```       = "/src/vanjee_lidar_sdk/param/Vanjee_720_HA.csv"(absolute path), 
